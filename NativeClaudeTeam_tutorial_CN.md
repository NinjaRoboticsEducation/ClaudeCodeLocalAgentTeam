...
- [Native Claude Team 教程](#native-claude-team-教程)
  - [你将搭建什么](#你将搭建什么)
  - [隐私和安全说明](#隐私和安全说明)
  - [目录](#目录)
- [1. 基础设置：本地 Agent Team](#1-基础设置本地-agent-team)
  ...
  - [1.4 安装必要软件](#14-安装必要软件)
    - [1.4.1 安装 Homebrew](#141-安装-homebrew)
    - [1.4.2 安装 Node.js 和 npm](#142-安装-nodejs-和-npm)
    - [1.4.3 安装 Git](#143-安装-git)
    - [1.4.4 安装 Ollama](#144-安装-ollama)
    - [1.4.5 安装 Claude Code](#145-安装-claude-code)
    - [1.4.6 安装 uv](#146-安装-uv)
  ...
  - [1.12 创建 Agent Team](#112-创建-agent-team)
    - [1.12.1 UI/UX 设计代理人](#1121-uiux-设计代理人)
    - [1.12.2 React 架构代理人](#1122-react-架构代理人)
    - [1.12.3 内容生成代理人](#1123-内容生成代理人)
  - [1.13 运行 Agent Team](#113-运行-agent-team)
    - [1.13.1 先测试一个代理人](#1131-先测试一个代理人)
    - [1.13.2 启动完整团队](#1132-启动完整团队)
  - [1.14 预览并清理](#114-预览并清理)
  - [1.15 复用这个模式](#115-复用这个模式)
- [2. 故障排查](#2-故障排查)
  - [Claude Code 无法连接 Ollama](#claude-code-无法连接-ollama)
  - [找不到模型](#找不到模型)
  - [Agent Teams 没有出现](#agent-teams-没有出现)
  - [队友使用错误模型](#队友使用错误模型)
  - [Nano Banana 没有出现](#nano-banana-没有出现)
  - [本地模型太慢](#本地模型太慢)
  - [构建失败](#构建失败)
- [3. 快速参考](#3-快速参考)
  - [基础本地启动](#基础本地启动)
