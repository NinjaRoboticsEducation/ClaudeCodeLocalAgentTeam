...
- [Native Claude Team チュートリアル](#native-claude-team-チュートリアル)
  - [このチュートリアルで作るもの](#このチュートリアルで作るもの)
  - [プライバシーと安全性について](#プライバシーと安全性について)
  - [目次](#目次)
- [1. 基本セットアップ：ローカル Agent Team](#1-基本セットアップローカル-agent-team)
  ...
  - [1.4 必要なソフトウェアを入れる](#14-必要なソフトウェアを入れる)
    - [1.4.1 Homebrew を入れる](#141-homebrew-を入れる)
    - [1.4.2 Node.js と npm を入れる](#142-nodejs-と-npm-を入れる)
    - [1.4.3 Git を入れる](#143-git-を入れる)
    - [1.4.4 Ollama を入れる](#144-ollama-を入れる)
    - [1.4.5 Claude Code を入れる](#145-claude-code-を入れる)
    - [1.4.6 uv を入れる](#146-uv-を入れる)
  ...
  - [1.12 Agent Team を作る](#112-agent-team-を作る)
    - [1.12.1 UI/UX デザイナーエージェント](#1121-uiux-デザイナーエージェント)
    - [1.12.2 React アーキテクトエージェント](#1122-react-アーキテクトエージェント)
    - [1.12.3 コンテンツ生成エージェント](#1123-コンテンツ生成エージェント)
  - [1.13 Agent Team を実行する](#113-agent-team-を実行する)
    - [1.13.1 最初は 1 エージェントだけでテストする](#1131-最初は-1-エージェントだけでテストする)
    - [1.13.2 フルチームを起動する](#1132-フルチームを起動する)
  - [1.14 プレビューして片付ける](#114-プレビューして片付ける)
  - [1.15 この型を再利用する](#115-この型を再利用する)
- [2. トラブルシューティング](#2-トラブルシューティング)
  - [Claude Code が Ollama に接続できない](#claude-code-が-ollama-に接続できない)
  - [モデルが見つからない](#モデルが見つからない)
  - [Agent Teams が表示されない](#agent-teams-が表示されない)
  - [チームメイトが違うモデルを使う](#チームメイトが違うモデルを使う)
  - [Nano Banana が表示されない](#nano-banana-が表示されない)
  - [ローカルモデルが遅すぎる](#ローカルモデルが遅すぎる)
  - [ビルドが失敗する](#ビルドが失敗する)
- [3. クイックリファレンス](#3-クイックリファレンス)
  - [基本のローカル起動](#基本のローカル起動)
  - [基本のローカル環境変数](#基本のローカル環境変数)
  - [Ollama コマンド](#ollama-コマンド)
  - [React コマンド](#react-コマンド)
  - [Nano Banana コマンド](#nano-banana-コマンド)
  - [Agent 関連フォルダ](#agent-関連フォルダ)
