...
- [Native Claude Team 教學](#native-claude-team-教學)
  - [你會建立什麼](#你會建立什麼)
  - [隱私與安全注意事項](#隱私與安全注意事項)
  - [目錄](#目錄)
- [1. 基本設定：本機 Agent Team](#1-基本設定本機-agent-team)
  ...
  - [1.4 安裝必要軟體](#14-安裝必要軟體)
    - [1.4.1 安裝 Homebrew](#141-安裝-homebrew)
    - [1.4.2 安裝 Node.js 與 npm](#142-安裝-nodejs-與-npm)
    - [1.4.3 安裝 Git](#143-安裝-git)
    - [1.4.4 安裝 Ollama](#144-安裝-ollama)
    - [1.4.5 安裝 Claude Code](#145-安裝-claude-code)
    - [1.4.6 安裝 uv](#146-安裝-uv)
  ...
  - [1.12 建立 Agent Team](#112-建立-agent-team)
    - [1.12.1 UI/UX 設計代理人](#1121-uiux-設計代理人)
    - [1.12.2 React 架構代理人](#1122-react-架構代理人)
    - [1.12.3 內容生成代理人](#1123-內容生成代理人)
  - [1.13 執行 Agent Team](#113-執行-agent-team)
    - [1.13.1 先測一個代理人](#1131-先測一個代理人)
    - [1.13.2 啟動完整團隊](#1132-啟動完整團隊)
  - [1.14 預覽並清理](#114-預覽並清理)
  - [1.15 重複使用這個模式](#115-重複使用這個模式)
- [2. 疑難排解](#2-疑難排解)
  - [Claude Code 無法連到 Ollama](#claude-code-無法連到-ollama)
  - [找不到模型](#找不到模型)
  - [Agent Teams 沒出現](#agent-teams-沒出現)
  - [隊友使用錯誤模型](#隊友使用錯誤模型)
  - [Nano Banana 沒出現](#nano-banana-沒出現)
  - [本機模型太慢](#本機模型太慢)
  - [建置失敗](#建置失敗)
- [3. 快速參考](#3-快速參考)
  - [基本本機啟動](#基本本機啟動)
